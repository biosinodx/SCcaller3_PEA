...
echo -----------------------------------------------------------------------------------
#cat paired.fa pairedold.fa > pairedNew.fa
time ../SSAKE -f ecoli_miseqTrimmed_paired.fa -g ecoli_miseqTrimmed_unpaired.fa -p 1 -m 80 -w 100 -b coliMiSeq300m80
echo -----------------------------------------------------------------------------------
...
echo -----------------------------------------------------------------------------------
../tools/getStats.pl coliMiSeq300m80.scaffolds.fa > coliMiSeq300m80.scaffolds.stats
