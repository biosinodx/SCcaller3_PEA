...
#
vcf <- readVcf(paste(sn, "/results/variants/somaticSV.pass.vcf", sep=''), "hg38")
...
writeVcf(vcf_filt, paste(sn, ".manta.somatic.concensus.vcf", sep=''))
